...
| **Mutual confidence** | Mediated contact requests, trust cards, safe meetup suggestions on contact/contract/claim screens |
...
_All proposal modules are implemented._ Optional polish: full in-app chat relay, FCM background push (Blaze), Google Places POI lookup.
...
- **Advanced trust/legal features** (nearby, search, broadcast, contracts, recovery, mutual confidence, admin legal export): **done**
